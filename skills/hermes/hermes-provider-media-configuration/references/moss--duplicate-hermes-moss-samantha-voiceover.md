# Archived duplicate skill: moss

Original path: `/Users/Kosta/.hermes/skills/hermes__moss-samantha-voiceover`
Absorbed into umbrella: `hermes-provider-media-configuration` on 2026-04-29 duplicate cleanup.
...
name: moss
description: >-
  Generate or debug local MOSS/Samantha voiceovers, including short spoken-style memos, multilingual or Hebrew voice cloning, language codes, pronunciation, TTS command defaults, and delivery-ready audio.
targets:
  - hermes-default
  - hermes-gpt
metadata:
...
## MOSS multilingual voice lane
MOSS voiceover is the umbrella; multilingual/Hebrew voice cloning is a lane with provider-specific quirks and pronunciation guidance.

Reference files retained from the absorbed narrow skills:
- `moss-multilingual-voice-cloning.md` — source material from `moss-multilingual-voice-cloning`.

Use these as detail banks, not as separate trigger surfaces. Load only the relevant reference when the user needs that lane, provider, or troubleshooting case.
