---
name: image-first-ppt-workflow_NyxTides
description: 'Use when the user wants a high-fidelity visual deck workflow with style previews, image-generated full-slide pages, review loops, or “show me visual directions first” before producing a PPT container. Best for polished presentation visuals, defense/report/product decks, and rough-topic-to-deck planning; not for fully editable native PPT objects.'
metadata:
  upstream: https://github.com/NyxTides/ppt-image-first
  best_for: 'Conversation-first, image-first deck planning with visual previews and review gates; GPT Image-style full-page slide visuals.'
---
> Imported from [https://github.com/NyxTides/ppt-image-first](https://github.com/NyxTides/ppt-image-first) and renamed for Skillshare routing. Best for: Conversation-first, image-first deck planning with visual previews and review gates; GPT Image-style full-page slide visuals.
