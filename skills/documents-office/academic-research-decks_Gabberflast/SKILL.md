---
name: academic-research-decks_Gabberflast
description: 'Use when a deck is for academic research: conference talks, seminar slides, thesis defenses, grant briefings, lab meetings, invited lectures, or biomedical/scientific presentations where the argument, evidence, citations, and action-title story matter more than decorative design. Pair with documents-office__powerpoint for actual .pptx creation/editing.'
metadata:
  upstream: https://github.com/Gabberflast/academic-pptx-skill
  best_for: 'Academic/research slide structure, action titles, citations, argument flow, thesis/conference/grant talks.'
---
> Imported from [https://github.com/Gabberflast/academic-pptx-skill](https://github.com/Gabberflast/academic-pptx-skill) and renamed for Skillshare routing. Best for: Academic/research slide structure, action titles, citations, argument flow, thesis/conference/grant talks.
...
**When producing a native `.pptx`, load the local PowerPoint skill too before writing code or files.**
...
| Task | Guide |
|------|-------|
| Content planning, argument structure, slide-by-slide rules | [content_guidelines.md](references/content_guidelines.md) |
| Per-slide-type patterns (title, methods, results, etc.) | [slide_patterns.md](references/slide_patterns.md) |
...
Follow [content_guidelines.md](references/content_guidelines.md) in full.
