---
name: web-presentation-magazine-swiss_op7418
description: 'Use when the desired deliverable is a single-file horizontal-swipe HTML presentation, magazine-style web deck, Swiss-style web slides, keynote-like talk page, social cover, or visually distinctive browser deck rather than a native editable .pptx. Especially good for editorial narrative talks, product launches, salons, and stylish shareable web presentations.'
metadata:
  upstream: https://github.com/op7418/guizang-ppt-skill
  best_for: 'Single-file HTML horizontal web decks with editorial-magazine or Swiss International style systems, covers, and browser-based presentations.'
---
> Imported from [https://github.com/op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill) and renamed for Skillshare routing. Best for: Single-file HTML horizontal web decks with editorial-magazine or Swiss International style systems, covers, and browser-based presentations.
