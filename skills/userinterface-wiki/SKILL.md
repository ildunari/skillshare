...
description: "Production UI/UX best practices and animation pipeline for web interfaces. Use when implementing or reviewing animations (CSS, GSAP, Framer Motion, WAAPI, Anime.js), choosing animation tools, scroll-driven effects, view transitions, FLIP layout animation, spring physics, exit animations, reduced-motion accessibility, audio feedback, typography, visual design, UX patterns, Lottie/Rive, Three.js/WebGL, or Paper.js generative art."
license: MIT
metadata:
