...
Use the HyperFrames CLI audio/transcript tooling when possible. If a custom extractor is needed, write a short project-local script for that project, review it before running, and keep generated JSON under the project directory rather than inside the shared skill.
