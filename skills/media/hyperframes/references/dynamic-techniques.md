...
| **audio data**      | Pre-extracted per-frame RMS energy and frequency bands.                   | Generate project-local JSON and embed it directly in the composition data block                | Audio-reactive visuals — modulate intensity based on the music               |
