---
name: research-distiller-fusion
description: >
  ...
  for any domain. Pairs naturally with the deep-research-prompting skill as its downstream
  consumer.
---

# Research Distiller (Fusion)
...
**Upstream:** This skill pairs naturally with `deep-research-prompting`. Reports produced via that skill's structure (focus areas, tiered sources, reporting requirements) are easier to distill because they have consistent structure and explicit sourcing.
