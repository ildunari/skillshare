...
| **visual-analyzer** | When extracting design tokens from an existing UI to feed into image gen prompts |
| **openclaw-avatar-gen** | When generating avatars specifically for OpenClaw agents (that skill is more specialized) |
...
| **prompt-architect / gpt-prompt-architect** | When writing system prompts for AI, not image gen prompts — different domain entirely |
