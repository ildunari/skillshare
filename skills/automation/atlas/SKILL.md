---
name: "atlas"
description: "Use when the user explicitly asks to control the ChatGPT Atlas desktop app on macOS, especially Atlas tabs, bookmarks, or history, and the app is installed. Do not use for general browser automation, non-macOS environments, or tasks that do not specifically involve Atlas."
---
