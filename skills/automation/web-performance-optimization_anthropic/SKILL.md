---
name: web-performance-optimization_anthropic
user-invocable: false
description: "Use when the user wants to diagnose or improve website or web app performance, including loading speed, Core Web Vitals, bundle size, caching, rendering cost, or runtime bottlenecks. Trigger on reports of slow pages, Lighthouse or Web Vitals work, bundle or asset slimming, cache tuning, or preparation for a web performance audit."
---
