---
name: nextjs-app-router-architecture_reactjs
user-invocable: false
description: Master Next.js 14+ App Router architecture with Server Components, streaming, parallel routes, and advanced data fetching. Use when building or restructuring Next.js applications, implementing SSR or SSG, or optimizing React Server Components. Supersedes `nextjs-app-router-patterns`.
---
