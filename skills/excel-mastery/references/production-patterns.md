...
If the xlsx public skill is also loaded, use that skill for boilerplate file-creation mechanics. This file focuses specifically on applying excel-mastery design principles in code.
