...
5. **Trace Data Flow**
   ...
   See `root-cause-tracing.md` in this skill directory for the complete backward tracing technique.
...
1. **Create Failing Test Case** - Use [skill:test-driven-development] for writing proper failing tests
...
These techniques are available in this skill directory:
