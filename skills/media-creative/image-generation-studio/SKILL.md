...
<!-- Merged from: image-prompt-architect (2026-04-05). Legacy material preserved under merged/. -->
...
- Use `tmp/image-generation-studio/` for intermediate files (for example JSONL batches); delete when done.
- Write final artifacts under `output/image-generation-studio/` when working in this repo.
