...
description: >
  ...
  skill for incorporation. Supersedes generic code review and prompt-architect
...
4. **Start the Scratchpad artifact.** Name it "Scratchpad — [skill-name]
   ...
   Impact: Users asking "review my skill's prompts" may trigger prompt-architect
   instead of this skill.
   Fix: Add "supersedes prompt-architect when the review target is a skill
