...
**Called by:**
- **[skill:brainstorming]** - REQUIRED when design is approved and implementation follows
- **[skill:subagent-driven-development]** - REQUIRED before executing any tasks
- **[skill:planning-protocol]** - REQUIRED before executing multi-step implementation work
