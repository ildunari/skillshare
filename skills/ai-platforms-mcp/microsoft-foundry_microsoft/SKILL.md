---
name: microsoft-foundry_microsoft
description: "Use when the task is specifically about Microsoft Foundry or Azure AI Foundry workflows: deploying agents or models, configuring Foundry projects and resources, running evaluations, optimizing prompts, checking quota or region capacity, or troubleshooting Foundry-specific failures. Trigger on requests mentioning Foundry agents, hosted or prompt agents, model deployments, evals, RBAC, knowledge indexes, trace-to-dataset flows, onboarding, or region availability. Do not use for general Azure deployment outside Foundry."
license: MIT
metadata:
  author: Microsoft
  version: "1.0.7"
