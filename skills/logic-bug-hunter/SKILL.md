...
description: Use when you need a deep static and runtime-informed pass to find flawed logic, unsafe assumptions, and behavior regressions before users hit them.
---
...
- Load `testing-protocol` when adding repro tests for discovered logic faults.
- Load `requesting-code-review` after fixes for severity-triaged validation.
