...
If `AGENTS.md/CLAUDE.md/GEMINI.md or the active agent instructions file` contains a `## Design Context` section (generated by `impeccable teach`), derive 1–2 additional personas from the audience and brand information:
