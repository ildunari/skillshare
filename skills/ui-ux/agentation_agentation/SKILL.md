---
name: agentation_agentation
user-invocable: false
description: Use when adding the Agentation visual feedback or annotation toolbar to a Next.js project, especially if the user asks to set up Agentation, clickable UI feedback, or developer-only interface annotation in Next.js.
---
# Agentation Setup
