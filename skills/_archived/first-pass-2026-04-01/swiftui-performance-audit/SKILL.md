...
description: Use when the user reports SwiftUI performance symptoms and needs diagnosis or remediation, including slow rendering, janky scrolling, dropped frames, high CPU or memory usage, excessive view invalidation, layout thrash, or expensive view bodies. Also use when reviewing SwiftUI code or architecture for performance risks, or when guiding the user through Instruments profiling because code review alone is not enough.
---
