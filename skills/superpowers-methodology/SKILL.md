...
description: Software development methodology adapted from obra/superpowers for Claude.ai chat. Covers structured problem decomposition, batched plan execution with checkpoints, two-stage self-review (spec compliance then code quality), code review with severity triage, and anti-performative feedback handling. Use this skill whenever building multi-step code, reviewing code, receiving feedback on code, debugging complex multi-failure problems, or executing any implementation plan. Also triggers on requests to "review this code," "build this feature," "help me plan," "what's wrong with this," or any task involving iterative code creation or evaluation. Even for single-file artifacts, apply the self-review phase silently.
---
