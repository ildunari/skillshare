---
name: pubmed-database_NIH
description: Use when the task is specifically about PubMed-based biomedical literature search, PMIDs, MeSH terms, E-utilities, or systematic review workflows in medicine and life sciences. Prefer this when the user wants to find medical papers, build advanced PubMed queries, or retrieve PubMed citation and abstract data programmatically.
---
# PubMed Database
