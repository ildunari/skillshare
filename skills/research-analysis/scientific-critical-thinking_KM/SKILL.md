---
name: scientific-critical-thinking_KM
description: Use when the task is to critically evaluate a scientific paper, claim, study design, methodology, evidence base, or statistical interpretation. Prefer this for finding bias, logical flaws, validity threats, weak inference, or evidence-quality problems in research, experiments, or scientific arguments rather than for open-ended ideation.
---
