...
- [5. Box and Violin Plots](#5-box-and-violin-plots)
- [6. Heatmaps](#6-heatmaps)
- [7. Contour Plots](#7-contour-plots)
- [8. Pie Charts](#8-pie-charts)
- [9. Polar Plots](#9-polar-plots)
- [10. Stream and Quiver Plots](#10-stream-and-quiver-plots)
- [11. Fill Between](#11-fill-between)
- [12. 3D Plots](#12-3d-plots)
- [13. Specialized Plots](#13-specialized-plots)
- [14. Time Series Plots](#14-time-series-plots)
- [Plot Selection Guide](#plot-selection-guide)
...
# Gate annotations by matrix size — text becomes illegible for large matrices.
# Rule: only annotate if both dims ≤ 15. Scale fontsize down for larger cells.
...
# For matrices > 15×15, skip per-cell labels and rely on colorbar + hover tooltips.
```
