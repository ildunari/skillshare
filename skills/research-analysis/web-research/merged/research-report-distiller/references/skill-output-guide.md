...
Write the description as if you're programming a classifier. Every way a user might phrase a request for this skill should be covered. Look at design-maestro, research-prompt-writer, and humanize-ai-content frontmatter for calibration.
