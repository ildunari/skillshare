---
name: statistical-analysis_KM
description: Use when the user needs to choose, run, diagnose, or report a rigorous statistical analysis for research, especially hypothesis tests, regression, Bayesian analysis, assumption checks, effect sizes, power analysis, or publication-style reporting. Prefer this when someone asks which statistical test to run, how to interpret a result, or how to analyze data in Python to academic standards.
---
